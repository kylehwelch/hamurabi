...
public class HammurabiTest {
    ...
    public final void testPlagueDeaths1() {
        ...
        for (int i = 0; i < 10000; i++) {
            int deaths = People.plagueDeaths(100);
            if (deaths > 0) {
                number_of_plagues += 1;
            }
        }
    ...
    public final void testPlagueDeaths2() {
        int deaths = 0;
        for (int i = 0; i < 10000; i++) {
            deaths = People.plagueDeaths(100);
            if (deaths > 0) break;
        }
    ...
    public final void testStarvationDeaths() {
        ...
        deaths = People.starvationDeaths(100, 2500);
        if (deaths < 0) {
    ...
    public final void testUprising() {
        assertTrue("Should have had an uprising!", People.uprising(1000, 451));
        assertFalse("Should not have had an uprising!", People.uprising(1000, 449));
    }

    @Test
    public final void testImmigrants() {
        int imm = People.immigrants(10, 1200, 500);
